...
/**********************************************************************
**	File: /home/alireza/work/hca_git/ProNoC/mpsoc/src_topolgy/test/test_topology_genvar.v
**    
...
//Connect R0 input ports 1 to  R1 output ports 3
		...
		assign  router_flit_in_wr_all [0][1] = router_flit_out_wr_all [1][3];
...
//Connect R0 port 2 to  ground
		...
		assign  router_flit_in_wr_all [0][2] = 1'b0;
...
//Connect R0 port 3 to  ground
		...
		assign  router_flit_in_wr_all [0][3] = 1'b0;
...
//Connect R0 input ports 4 to  R3 output ports 2
		...
		assign  router_flit_in_wr_all [0][4] = router_flit_out_wr_all [3][2];
...
//Connect R1 port 2 to  ground
		...
		assign  router_flit_in_wr_all [1][2] = 1'b0;
...
//Connect R1 input ports 3 to  R0 output ports 1
		...
		assign  router_flit_in_wr_all [1][3] = router_flit_out_wr_all [0][1];
...
//Connect R1 input ports 4 to  R4 output ports 2
		...
		assign  router_flit_in_wr_all [1][4] = router_flit_out_wr_all [4][2];
...
//Connect R2 input ports 1 to  R3 output ports 3
		...
		assign  router_flit_in_wr_all [2][1] = router_flit_out_wr_all [3][3];
...
//Connect R2 port 2 to  ground
		...
		assign  router_flit_in_wr_all [2][2] = 1'b0;
...
//Connect R2 input ports 4 to  R5 output ports 2
		...
		assign  router_flit_in_wr_all [2][4] = router_flit_out_wr_all [5][2];
...
//Connect R3 input ports 1 to  R4 output ports 3
		...
		assign  router_flit_in_wr_all [3][1] = router_flit_out_wr_all [4][3];
...
//Connect R3 input ports 2 to  R0 output ports 4
		...
		assign  router_flit_in_wr_all [3][2] = router_flit_out_wr_all [0][4];
...
//Connect R3 input ports 3 to  R2 output ports 1
		...
		assign  router_flit_in_wr_all [3][3] = router_flit_out_wr_all [2][1];
...
//Connect R3 input ports 4 to  R6 output ports 2
		...
		assign  router_flit_in_wr_all [3][4] = router_flit_out_wr_all [6][2];
...
//Connect R4 input ports 1 to  R5 output ports 3
		...
		assign  router_flit_in_wr_all [4][1] = router_flit_out_wr_all [5][3];
...
//Connect R4 input ports 2 to  R1 output ports 4
		...
		assign  router_flit_in_wr_all [4][2] = router_flit_out_wr_all [1][4];
...
//Connect R4 input ports 3 to  R3 output ports 1
		...
		assign  router_flit_in_wr_all [4][3] = router_flit_out_wr_all [3][1];
...
//Connect R4 input ports 4 to  R7 output ports 2
		...
		assign  router_flit_in_wr_all [4][4] = router_flit_out_wr_all [7][2];
...
//Connect R5 input ports 1 to  R6 output ports 3
		...
		assign  router_flit_in_wr_all [5][1] = router_flit_out_wr_all [6][3];
...
//Connect R5 input ports 2 to  R2 output ports 4
		...
		assign  router_flit_in_wr_all [5][2] = router_flit_out_wr_all [2][4];
...
//Connect R5 input ports 3 to  R4 output ports 1
		...
		assign  router_flit_in_wr_all [5][3] = router_flit_out_wr_all [4][1];
...
//Connect R5 input ports 4 to  R8 output ports 2
		...
		assign  router_flit_in_wr_all [5][4] = router_flit_out_wr_all [8][2];
...
//Connect R6 input ports 1 to  R7 output ports 3
		...
		assign  router_flit_in_wr_all [6][1] = router_flit_out_wr_all [7][3];
...
//Connect R6 input ports 2 to  R3 output ports 4
		...
		assign  router_flit_in_wr_all [6][2] = router_flit_out_wr_all [3][4];
...
//Connect R6 input ports 3 to  R5 output ports 1
		...
		assign  router_flit_in_wr_all [6][3] = router_flit_out_wr_all [5][1];
...
//Connect R6 port 4 to  ground
		...
		assign  router_flit_in_wr_all [6][4] = 1'b0;
...
//Connect R7 input ports 2 to  R4 output ports 4
		...
		assign  router_flit_in_wr_all [7][2] = router_flit_out_wr_all [4][4];
...
//Connect R7 input ports 3 to  R6 output ports 1
		...
		assign  router_flit_in_wr_all [7][3] = router_flit_out_wr_all [6][1];
...
//Connect R7 port 4 to  ground
		...
		assign  router_flit_in_wr_all [7][4] = 1'b0;
...
//Connect R8 port 1 to  ground
		...
		assign  router_flit_in_wr_all [8][1] = 1'b0;
...
//Connect R8 input ports 2 to  R5 output ports 4
		...
		assign  router_flit_in_wr_all [8][2] = router_flit_out_wr_all [5][4];
...
//Connect R8 port 4 to  ground
		...
		assign  router_flit_in_wr_all [8][4] = 1'b0;

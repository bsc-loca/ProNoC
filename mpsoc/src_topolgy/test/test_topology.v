...
/**********************************************************************
**	File: /home/alireza/work/hca_git/ProNoC/mpsoc/src_topolgy/test/test_topology.v
**    
...
module   test_noc #(  
	...
	*******************/
	...
	wire [(5*1)-1 : 0] R0_flit_in_we_all;
	wire [(5*1)-1 : 0] R0_flit_out_we_all;
	...
	*******************/
	...
	wire [(5*1)-1 : 0] R1_flit_in_we_all;
	wire [(5*1)-1 : 0] R1_flit_out_we_all;
	...
	*******************/
	...
	wire [(5*1)-1 : 0] R2_flit_in_we_all;
	wire [(5*1)-1 : 0] R2_flit_out_we_all;
	...
	*******************/
	...
	wire [(5*1)-1 : 0] R3_flit_in_we_all;
	wire [(5*1)-1 : 0] R3_flit_out_we_all;
	...
	*******************/
	...
	wire [(5*1)-1 : 0] R4_flit_in_we_all;
	wire [(5*1)-1 : 0] R4_flit_out_we_all;
	...
	*******************/
	...
	wire [(5*1)-1 : 0] R5_flit_in_we_all;
	wire [(5*1)-1 : 0] R5_flit_out_we_all;
	...
	*******************/
	...
	wire [(5*1)-1 : 0] R6_flit_in_we_all;
	wire [(5*1)-1 : 0] R6_flit_out_we_all;
	...
	*******************/
	...
	wire [(5*1)-1 : 0] R7_flit_in_we_all;
	wire [(5*1)-1 : 0] R7_flit_out_we_all;
	...
	*******************/
	...
	wire [(5*1)-1 : 0] R8_flit_in_we_all;
	wire [(5*1)-1 : 0] R8_flit_out_we_all;
	...
	*******************/
	...
	(	
		...
		.flit_in_we_all(R0_flit_in_we_all),
		.flit_out_we_all(R0_flit_out_we_all),
...
//Connect R0 port 0 to  T0 port 0
		...
		assign  R0_flit_in_we_all [0] = T0_flit_in_we ;
...
//Connect R0 port 1 to  R1 port 3
		...
		assign  R0_flit_in_we_all [1] = R1_flit_out_we_all [3];
...
//Connect R0 port 2 to  ground
		...
		assign  R0_flit_in_we_all [2] = {1{1'b0}};
...
//Connect R0 port 3 to  ground
		...
		assign  R0_flit_in_we_all [3] = {1{1'b0}};
...
//Connect R0 port 4 to  R3 port 2
		...
		assign  R0_flit_in_we_all [4] = R3_flit_out_we_all [2];
	...
	*******************/
	...
	(	
		...
		.flit_in_we_all(R1_flit_in_we_all),
		.flit_out_we_all(R1_flit_out_we_all),
...
//Connect R1 port 0 to  T1 port 0
		...
		assign  R1_flit_in_we_all [0] = T1_flit_in_we ;
...
//Connect R1 port 1 to  R2 port 3
		...
		assign  R1_flit_in_we_all [1] = R2_flit_out_we_all [3];
...
//Connect R1 port 2 to  ground
		...
		assign  R1_flit_in_we_all [2] = {1{1'b0}};
...
//Connect R1 port 3 to  R0 port 1
		...
		assign  R1_flit_in_we_all [3] = R0_flit_out_we_all [1];
...
//Connect R1 port 4 to  R4 port 2
		...
		assign  R1_flit_in_we_all [4] = R4_flit_out_we_all [2];
	...
	*******************/
	...
	(	
		...
		.flit_in_we_all(R2_flit_in_we_all),
		.flit_out_we_all(R2_flit_out_we_all),
...
//Connect R2 port 0 to  T2 port 0
		...
		assign  R2_flit_in_we_all [0] = T2_flit_in_we ;
...
//Connect R2 port 1 to  R3 port 3
		...
		assign  R2_flit_in_we_all [1] = R3_flit_out_we_all [3];
...
//Connect R2 port 2 to  ground
		...
		assign  R2_flit_in_we_all [2] = {1{1'b0}};
...
//Connect R2 port 3 to  R1 port 1
		...
		assign  R2_flit_in_we_all [3] = R1_flit_out_we_all [1];
...
//Connect R2 port 4 to  R5 port 2
		...
		assign  R2_flit_in_we_all [4] = R5_flit_out_we_all [2];
	...
	*******************/
	...
	(	
		...
		.flit_in_we_all(R3_flit_in_we_all),
		.flit_out_we_all(R3_flit_out_we_all),
...
//Connect R3 port 0 to  T3 port 0
		...
		assign  R3_flit_in_we_all [0] = T3_flit_in_we ;
...
//Connect R3 port 1 to  R4 port 3
		...
		assign  R3_flit_in_we_all [1] = R4_flit_out_we_all [3];
...
//Connect R3 port 2 to  R0 port 4
		...
		assign  R3_flit_in_we_all [2] = R0_flit_out_we_all [4];
...
//Connect R3 port 3 to  R2 port 1
		...
		assign  R3_flit_in_we_all [3] = R2_flit_out_we_all [1];
...
//Connect R3 port 4 to  R6 port 2
		...
		assign  R3_flit_in_we_all [4] = R6_flit_out_we_all [2];
	...
	*******************/
	...
	(	
		...
		.flit_in_we_all(R4_flit_in_we_all),
		.flit_out_we_all(R4_flit_out_we_all),
...
//Connect R4 port 0 to  T4 port 0
		...
		assign  R4_flit_in_we_all [0] = T4_flit_in_we ;
...
//Connect R4 port 1 to  R5 port 3
		...
		assign  R4_flit_in_we_all [1] = R5_flit_out_we_all [3];
...
//Connect R4 port 2 to  R1 port 4
		...
		assign  R4_flit_in_we_all [2] = R1_flit_out_we_all [4];
...
//Connect R4 port 3 to  R3 port 1
		...
		assign  R4_flit_in_we_all [3] = R3_flit_out_we_all [1];
...
//Connect R4 port 4 to  R7 port 2
		...
		assign  R4_flit_in_we_all [4] = R7_flit_out_we_all [2];
	...
	*******************/
	...
	(	
		...
		.flit_in_we_all(R5_flit_in_we_all),
		.flit_out_we_all(R5_flit_out_we_all),
...
//Connect R5 port 0 to  T5 port 0
		...
		assign  R5_flit_in_we_all [0] = T5_flit_in_we ;
...
//Connect R5 port 1 to  R6 port 3
		...
		assign  R5_flit_in_we_all [1] = R6_flit_out_we_all [3];
...
//Connect R5 port 2 to  R2 port 4
		...
		assign  R5_flit_in_we_all [2] = R2_flit_out_we_all [4];
...
//Connect R5 port 3 to  R4 port 1
		...
		assign  R5_flit_in_we_all [3] = R4_flit_out_we_all [1];
...
//Connect R5 port 4 to  R8 port 2
		...
		assign  R5_flit_in_we_all [4] = R8_flit_out_we_all [2];
	...
	*******************/
	...
	(	
		...
		.flit_in_we_all(R6_flit_in_we_all),
		.flit_out_we_all(R6_flit_out_we_all),
...
//Connect R6 port 0 to  T6 port 0
		...
		assign  R6_flit_in_we_all [0] = T6_flit_in_we ;
...
//Connect R6 port 1 to  R7 port 3
		...
		assign  R6_flit_in_we_all [1] = R7_flit_out_we_all [3];
...
//Connect R6 port 2 to  R3 port 4
		...
		assign  R6_flit_in_we_all [2] = R3_flit_out_we_all [4];
...
//Connect R6 port 3 to  R5 port 1
		...
		assign  R6_flit_in_we_all [3] = R5_flit_out_we_all [1];
...
//Connect R6 port 4 to  ground
		...
		assign  R6_flit_in_we_all [4] = {1{1'b0}};
	...
	*******************/
	...
	(	
		...
		.flit_in_we_all(R7_flit_in_we_all),
		.flit_out_we_all(R7_flit_out_we_all),
...
//Connect R7 port 0 to  T7 port 0
		...
		assign  R7_flit_in_we_all [0] = T7_flit_in_we ;
...
//Connect R7 port 1 to  R8 port 3
		...
		assign  R7_flit_in_we_all [1] = R8_flit_out_we_all [3];
...
//Connect R7 port 2 to  R4 port 4
		...
		assign  R7_flit_in_we_all [2] = R4_flit_out_we_all [4];
...
//Connect R7 port 3 to  R6 port 1
		...
		assign  R7_flit_in_we_all [3] = R6_flit_out_we_all [1];
...
//Connect R7 port 4 to  ground
		...
		assign  R7_flit_in_we_all [4] = {1{1'b0}};
	...
	*******************/
	...
	(	
		...
		.flit_in_we_all(R8_flit_in_we_all),
		.flit_out_we_all(R8_flit_out_we_all),
...
//Connect R8 port 0 to  T8 port 0
		...
		assign  R8_flit_in_we_all [0] = T8_flit_in_we ;
...
//Connect R8 port 1 to  ground
		...
		assign  R8_flit_in_we_all [1] = {1{1'b0}};
...
//Connect R8 port 2 to  R5 port 4
		...
		assign  R8_flit_in_we_all [2] = R5_flit_out_we_all [4];
...
//Connect R8 port 3 to  R7 port 1
		...
		assign  R8_flit_in_we_all [3] = R7_flit_out_we_all [1];
...
//Connect R8 port 4 to  ground
		...
		assign  R8_flit_in_we_all [4] = {1{1'b0}};
    ...
    //Connect T0 output ports 0 to  R0 input ports 0
		...
		assign  T0_flit_out_we   = R0_flit_out_we_all [0];
...
//Connect T1 output ports 0 to  R1 input ports 0
		...
		assign  T1_flit_out_we   = R1_flit_out_we_all [0];
...
//Connect T2 output ports 0 to  R2 input ports 0
		...
		assign  T2_flit_out_we   = R2_flit_out_we_all [0];
...
//Connect T3 output ports 0 to  R3 input ports 0
		...
		assign  T3_flit_out_we   = R3_flit_out_we_all [0];
...
//Connect T4 output ports 0 to  R4 input ports 0
		...
		assign  T4_flit_out_we   = R4_flit_out_we_all [0];
...
//Connect T5 output ports 0 to  R5 input ports 0
		...
		assign  T5_flit_out_we   = R5_flit_out_we_all [0];
...
//Connect T6 output ports 0 to  R6 input ports 0
		...
		assign  T6_flit_out_we   = R6_flit_out_we_all [0];
...
//Connect T7 output ports 0 to  R7 input ports 0
		...
		assign  T7_flit_out_we   = R7_flit_out_we_all [0];
...
//Connect T8 output ports 0 to  R8 input ports 0
		...
		assign  T8_flit_out_we   = R8_flit_out_we_all [0];

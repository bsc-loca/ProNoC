...
/**********************************************************************
**	File: /home/alireza/work/hca_git/ProNoC/mpsoc/src_topolgy/test/test_look_ahead_routing_genvar.v
**    
...
/*****************************
*	test_look_ahead_routing_genvar
******************************/ 
module test_look_ahead_routing_genvar  #(
	parameter RAw = 3,  
	parameter EAw = 3,   
	parameter DSTPw=4,
...
******************** 
 ...
 module test_look_ahead_routing_genvar_comb  #(
	parameter RAw = 3,  
	parameter EAw = 3,   
	parameter DSTPw=4,
	parameter CURRENT_R_ADDR=0

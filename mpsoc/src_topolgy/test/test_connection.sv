...
module   test_connection (
	...
	input	 [PFw-1 : 0] router_flit_out_all [NR-1 :0];
	input	[NE-1 : 0] ni_flit_in_we ;
	output	[NE-1 : 0] ni_flit_out_we ;
	input	 [P-1 : 0] router_flit_in_we_all [NR-1 :0];
	input	 [P-1 : 0] router_flit_out_we_all [NR-1 :0];
	output	[V-1 : 0] ni_credit_out [NE-1 : 0];
	input	[V-1 : 0] ni_credit_in [NE-1 : 0];
	output	 [PV-1 : 0] router_credit_out_all [NR-1 :0];
	output	 [PV-1 : 0] router_credit_in_all [NR-1 :0];
...
//Connect R0 input ports 0 to  T0 output ports 0
		...
		assign  ni_flit_out_we [0] = router_flit_in_we_all [0][0];
...
//Connect R0 input ports 1 to  R1 output ports 3
		...
		assign  router_flit_out_we_all [1][3] = router_flit_in_we_all [0][1];
...
//Connect R0 input ports 4 to  R3 output ports 2
		...
		assign  router_flit_out_we_all [3][2] = router_flit_in_we_all [0][4];
...
//Connect R1 input ports 0 to  T1 output ports 0
		...
		assign  ni_flit_out_we [1] = router_flit_in_we_all [1][0];
...
//Connect R1 input ports 1 to  R2 output ports 3
		...
		assign  router_flit_out_we_all [2][3] = router_flit_in_we_all [1][1];
...
//Connect R1 input ports 3 to  R0 output ports 1
		...
		assign  router_flit_out_we_all [0][1] = router_flit_in_we_all [1][3];
...
//Connect R1 input ports 4 to  R4 output ports 2
		...
		assign  router_flit_out_we_all [4][2] = router_flit_in_we_all [1][4];
...
//Connect R2 input ports 0 to  T2 output ports 0
		...
		assign  ni_flit_out_we [2] = router_flit_in_we_all [2][0];
...
//Connect R2 input ports 1 to  R3 output ports 3
		...
		assign  router_flit_out_we_all [3][3] = router_flit_in_we_all [2][1];
...
//Connect R2 input ports 3 to  R1 output ports 1
		...
		assign  router_flit_out_we_all [1][1] = router_flit_in_we_all [2][3];
...
//Connect R2 input ports 4 to  R5 output ports 2
		...
		assign  router_flit_out_we_all [5][2] = router_flit_in_we_all [2][4];
...
//Connect R3 input ports 0 to  T3 output ports 0
		...
		assign  ni_flit_out_we [3] = router_flit_in_we_all [3][0];
...
//Connect R3 input ports 1 to  R4 output ports 3
		...
		assign  router_flit_out_we_all [4][3] = router_flit_in_we_all [3][1];
...
//Connect R3 input ports 2 to  R0 output ports 4
		...
		assign  router_flit_out_we_all [0][4] = router_flit_in_we_all [3][2];
...
//Connect R3 input ports 3 to  R2 output ports 1
		...
		assign  router_flit_out_we_all [2][1] = router_flit_in_we_all [3][3];
...
//Connect R3 input ports 4 to  R6 output ports 2
		...
		assign  router_flit_out_we_all [6][2] = router_flit_in_we_all [3][4];
...
//Connect R4 input ports 0 to  T4 output ports 0
		...
		assign  ni_flit_out_we [4] = router_flit_in_we_all [4][0];
...
//Connect R4 input ports 1 to  R5 output ports 3
		...
		assign  router_flit_out_we_all [5][3] = router_flit_in_we_all [4][1];
...
//Connect R4 input ports 2 to  R1 output ports 4
		...
		assign  router_flit_out_we_all [1][4] = router_flit_in_we_all [4][2];
...
//Connect R4 input ports 3 to  R3 output ports 1
		...
		assign  router_flit_out_we_all [3][1] = router_flit_in_we_all [4][3];
...
//Connect R4 input ports 4 to  R7 output ports 2
		...
		assign  router_flit_out_we_all [7][2] = router_flit_in_we_all [4][4];
...
//Connect R5 input ports 0 to  T5 output ports 0
		...
		assign  ni_flit_out_we [5] = router_flit_in_we_all [5][0];
...
//Connect R5 input ports 1 to  R6 output ports 3
		...
		assign  router_flit_out_we_all [6][3] = router_flit_in_we_all [5][1];
...
//Connect R5 input ports 2 to  R2 output ports 4
		...
		assign  router_flit_out_we_all [2][4] = router_flit_in_we_all [5][2];
...
//Connect R5 input ports 3 to  R4 output ports 1
		...
		assign  router_flit_out_we_all [4][1] = router_flit_in_we_all [5][3];
...
//Connect R5 input ports 4 to  R8 output ports 2
		...
		assign  router_flit_out_we_all [8][2] = router_flit_in_we_all [5][4];
...
//Connect R6 input ports 0 to  T6 output ports 0
		...
		assign  ni_flit_out_we [6] = router_flit_in_we_all [6][0];
...
//Connect R6 input ports 1 to  R7 output ports 3
		...
		assign  router_flit_out_we_all [7][3] = router_flit_in_we_all [6][1];
...
//Connect R6 input ports 2 to  R3 output ports 4
		...
		assign  router_flit_out_we_all [3][4] = router_flit_in_we_all [6][2];
...
//Connect R6 input ports 3 to  R5 output ports 1
		...
		assign  router_flit_out_we_all [5][1] = router_flit_in_we_all [6][3];
...
//Connect R7 input ports 0 to  T7 output ports 0
		...
		assign  ni_flit_out_we [7] = router_flit_in_we_all [7][0];
...
//Connect R7 input ports 1 to  R8 output ports 3
		...
		assign  router_flit_out_we_all [8][3] = router_flit_in_we_all [7][1];
...
//Connect R7 input ports 2 to  R4 output ports 4
		...
		assign  router_flit_out_we_all [4][4] = router_flit_in_we_all [7][2];
...
//Connect R7 input ports 3 to  R6 output ports 1
		...
		assign  router_flit_out_we_all [6][1] = router_flit_in_we_all [7][3];
...
//Connect R8 input ports 0 to  T8 output ports 0
		...
		assign  ni_flit_out_we [8] = router_flit_in_we_all [8][0];
...
//Connect R8 input ports 2 to  R5 output ports 4
		...
		assign  router_flit_out_we_all [5][4] = router_flit_in_we_all [8][2];
...
//Connect R8 input ports 3 to  R7 output ports 1
		...
		assign  router_flit_out_we_all [7][1] = router_flit_in_we_all [8][3];
...
//Connect T0 input ports 0 to  R0 output ports 0
		...
		assign  router_flit_out_we_all [0][0] = ni_flit_in_we [0];
...
//Connect T1 input ports 0 to  R1 output ports 0
		...
		assign  router_flit_out_we_all [1][0] = ni_flit_in_we [1];
...
//Connect T2 input ports 0 to  R2 output ports 0
		...
		assign  router_flit_out_we_all [2][0] = ni_flit_in_we [2];
...
//Connect T3 input ports 0 to  R3 output ports 0
		...
		assign  router_flit_out_we_all [3][0] = ni_flit_in_we [3];
...
//Connect T4 input ports 0 to  R4 output ports 0
		...
		assign  router_flit_out_we_all [4][0] = ni_flit_in_we [4];
...
//Connect T5 input ports 0 to  R5 output ports 0
		...
		assign  router_flit_out_we_all [5][0] = ni_flit_in_we [5];
...
//Connect T6 input ports 0 to  R6 output ports 0
		...
		assign  router_flit_out_we_all [6][0] = ni_flit_in_we [6];
...
//Connect T7 input ports 0 to  R7 output ports 0
		...
		assign  router_flit_out_we_all [7][0] = ni_flit_in_we [7];
...
//Connect T8 input ports 0 to  R8 output ports 0
		...
		assign  router_flit_out_we_all [8][0] = ni_flit_in_we [8];

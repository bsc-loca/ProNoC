module custom_noc_connection (
 ...
 current_r_addr 
	...
	//do not modify this line ===muli===
    if(TOPOLOGY == "muli" ) begin : Tmuli
    
        muli_connection  connection
        (
		.reset(reset),
		.clk(clk),
		.start_i(start_i),
	...
	//do not modify this line ===l===
    if(TOPOLOGY == "l" ) begin : Tl
	...
	//do not modify this line ===ll===
    if(TOPOLOGY == "ll" ) begin : Tll
    
        ll_connection  connection
        (
		.reset(reset),
		.clk(clk),
		.start_i(start_i),

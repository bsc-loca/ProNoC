...
module   alireza_noc #(  
	...
	*******************/
	...
	wire [(5*RAw)-1:  0] R12_neighbors_r_addr;
	wire [(5*Fw)-1 : 0] R12_flit_in_all;
	wire [(5*Fw)-1 : 0] R12_flit_out_all;
	wire [(5*1)-1 : 0] R12_flit_in_wr_all;
	wire [(5*1)-1 : 0] R12_flit_out_wr_all;
	wire [(5*CONGw)-1 : 0] R12_congestion_in_all;
	wire [(5*CONGw)-1 : 0] R12_congestion_out_all;
	wire [(5*V)-1 : 0] R12_credit_out_all;
	wire [(5*V)-1 : 0] R12_credit_in_all;
	...
	*******************/
	...
	wire [(5*RAw)-1:  0] R13_neighbors_r_addr;
	wire [(5*Fw)-1 : 0] R13_flit_in_all;
	wire [(5*Fw)-1 : 0] R13_flit_out_all;
	wire [(5*1)-1 : 0] R13_flit_in_wr_all;
	wire [(5*1)-1 : 0] R13_flit_out_wr_all;
	wire [(5*CONGw)-1 : 0] R13_congestion_in_all;
	wire [(5*CONGw)-1 : 0] R13_congestion_out_all;
	wire [(5*V)-1 : 0] R13_credit_out_all;
	wire [(5*V)-1 : 0] R13_credit_in_all;
	...
	*******************/
	...
	wire [(5*RAw)-1:  0] R14_neighbors_r_addr;
	wire [(5*Fw)-1 : 0] R14_flit_in_all;
	wire [(5*Fw)-1 : 0] R14_flit_out_all;
	wire [(5*1)-1 : 0] R14_flit_in_wr_all;
	wire [(5*1)-1 : 0] R14_flit_out_wr_all;
	wire [(5*CONGw)-1 : 0] R14_congestion_in_all;
	wire [(5*CONGw)-1 : 0] R14_congestion_out_all;
	wire [(5*V)-1 : 0] R14_credit_out_all;
	wire [(5*V)-1 : 0] R14_credit_in_all;
	...
	*******************/
	...
	wire [(5*RAw)-1:  0] R15_neighbors_r_addr;
	wire [(5*Fw)-1 : 0] R15_flit_in_all;
	wire [(5*Fw)-1 : 0] R15_flit_out_all;
	wire [(5*1)-1 : 0] R15_flit_in_wr_all;
	wire [(5*1)-1 : 0] R15_flit_out_wr_all;
	wire [(5*CONGw)-1 : 0] R15_congestion_in_all;
	wire [(5*CONGw)-1 : 0] R15_congestion_out_all;
	wire [(5*V)-1 : 0] R15_credit_out_all;
	wire [(5*V)-1 : 0] R15_credit_in_all;
...
//Connect R8 port 4 to  R11 port 2
	...
	*******************/
	...
	(	
		...
		assign R9_current_r_addr = 9;
		assign R9_neighbors_r_addr=0;
//Connect R9 port 0 to  T9 port 0
		assign  R9_flit_in_all [(1*Fw)-1 : 		 0*Fw ] = T9_flit_in ;
...
//Connect R9 port 4 to  R3 port 4
	...
	*******************/
	...
	(	
		...
		assign R10_current_r_addr = 10;
		assign R10_neighbors_r_addr=0;
//Connect R10 port 0 to  T10 port 0
		assign  R10_flit_in_all [(1*Fw)-1 : 		 0*Fw ] = T10_flit_in ;
...
//Connect R10 port 4 to  R11 port 4
	...
	*******************/
	...
	(	
		...
		assign R11_current_r_addr = 11;
		assign R11_neighbors_r_addr=0;
//Connect R11 port 0 to  T11 port 0
		assign  R11_flit_in_all [(1*Fw)-1 : 		 0*Fw ] = T11_flit_in ;
...
//Connect R12 port 0 to  T12 port 0
		assign  R12_flit_in_all [(1*Fw)-1 : 		 0*Fw ] = T12_flit_in ;
...
//Connect R13 port 0 to  T13 port 0
		assign  R13_flit_in_all [(1*Fw)-1 : 		 0*Fw ] = T13_flit_in ;
...
//Connect R14 port 0 to  T14 port 0
		assign  R14_flit_in_all [(1*Fw)-1 : 		 0*Fw ] = T14_flit_in ;
...
//Connect R15 port 0 to  T15 port 0
		assign  R15_flit_in_all [(1*Fw)-1 : 		 0*Fw ] = T15_flit_in ;
...
//Connect T9 output ports 0 to  R9 input ports 0
		assign  T9_flit_out [Fw-1 : 		 0 ] = R9_flit_out_all [(1*Fw)-1 :	 0*Fw ];
		assign  T9_flit_out_wr   = R9_flit_out_wr_all [0];
		assign  R9_credit_in_all [(1*V)-1 :	 0*V ]= T9_credit_in [V-1 : 		 0 ];
//Connect T10 output ports 0 to  R10 input ports 0
		assign  T10_flit_out [Fw-1 : 		 0 ] = R10_flit_out_all [(1*Fw)-1 :	 0*Fw ];
		assign  T10_flit_out_wr   = R10_flit_out_wr_all [0];
		assign  R10_credit_in_all [(1*V)-1 :	 0*V ]= T10_credit_in [V-1 : 		 0 ];
//Connect T11 output ports 0 to  R11 input ports 0
		assign  T11_flit_out [Fw-1 : 		 0 ] = R11_flit_out_all [(1*Fw)-1 :	 0*Fw ];
		assign  T11_flit_out_wr   = R11_flit_out_wr_all [0];
		assign  R11_credit_in_all [(1*V)-1 :	 0*V ]= T11_credit_in [V-1 : 		 0 ];
//Connect T12 output ports 0 to  R12 input ports 0
		assign  T12_flit_out [Fw-1 : 		 0 ] = R12_flit_out_all [(1*Fw)-1 :	 0*Fw ];
		assign  T12_flit_out_wr   = R12_flit_out_wr_all [0];
		assign  R12_credit_in_all [(1*V)-1 :	 0*V ]= T12_credit_in [V-1 : 		 0 ];
//Connect T13 output ports 0 to  R13 input ports 0
		assign  T13_flit_out [Fw-1 : 		 0 ] = R13_flit_out_all [(1*Fw)-1 :	 0*Fw ];
		assign  T13_flit_out_wr   = R13_flit_out_wr_all [0];
		assign  R13_credit_in_all [(1*V)-1 :	 0*V ]= T13_credit_in [V-1 : 		 0 ];
//Connect T14 output ports 0 to  R14 input ports 0
		assign  T14_flit_out [Fw-1 : 		 0 ] = R14_flit_out_all [(1*Fw)-1 :	 0*Fw ];
		assign  T14_flit_out_wr   = R14_flit_out_wr_all [0];
		assign  R14_credit_in_all [(1*V)-1 :	 0*V ]= T14_credit_in [V-1 : 		 0 ];
//Connect T15 output ports 0 to  R15 input ports 0
		assign  T15_flit_out [Fw-1 : 		 0 ] = R15_flit_out_all [(1*Fw)-1 :	 0*Fw ];
		assign  T15_flit_out_wr   = R15_flit_out_wr_all [0];
		assign  R15_credit_in_all [(1*V)-1 :	 0*V ]= T15_credit_in [V-1 : 		 0 ];

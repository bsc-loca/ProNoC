...
module  ni_slave #(
    ...
    parameter Dw            =   32,
    parameter S_Aw          =   max3(7,INPUT_MEM_Aw,OUTPUT_MEM_Aw)+2,
    parameter M_Aw          =   32,
    parameter TAGw          =   3,
    parameter SELw          =   4
...
(
    ...
    wire  [Dw-1       :   0]      ctrl_dat_o;
    wire                          ctrl_ack_o;


    wire  [Dw-1       :   0]      in_dat_o;
    wire                          in_ack_o;


    wire  [Dw-1       :   0]      out_dat_o;
    wire                          out_ack_o;
    
    
    
    
    assign s_ack_o =  ctrl_ack_o | in_ack_o |  out_ack_o;
    
    assign s_dat_o = (s_addr_i <= )

...
multiple_path=$work_path/ssa_4x4
...
#cp $path/src_c/plot/plot $multiple_path/plot_bin
    ...
    ROUTE_NAME="XY"
    CLASS_SETTING="2'b11" #"16'b1000010000100001" 
   
#simulation parameters:
    C0_p=100 #25    #  the percentage of injected packets with class 0 
    C1_p=25
    C2_p=25
    C3_p=25
...
generate_plot_command
 ...
 do 
	for	TRAFFIC in  "RANDOM" #"TRANSPOSE1"  "BIT_REVERSE"  "BIT_COMPLEMENT"  "RANDOM"  "HOTSPOT"   "TORNADO" #"CUSTOM" 
	do

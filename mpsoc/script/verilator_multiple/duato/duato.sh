...
multiple_path=$work_path/mesh_2d_route
...
cp $path/src_c/plot/plot $multiple_path/plot_bin
    ...
    COMBINATION_TYPE="COMB_SPEC1" # "BASELINE" or "COMB_SPEC1" or "COMB_SPEC2" or "COMB_NONSPEC"
...
#simulation parameters:
 ...
 # Simulation parameters:   
	...
	CONGESTION_INDEX=12	# 0: packets are routed to the ports with more available VCs
...
route_setting(){
	case $routename in    
		...
		'DUATO_NORTH_LAST')
			...
			VC_REALLOCATION_TYPE="ATOMIC"	
			AVC_ATOMIC_EN=1	
			echo "DUATO_NORTH_LAST"

		;;
		'DUATO_ODD_EVEN')
			ROUTE_NAME="DUATO"
			ROUTE_SUBFUNC="ODD_EVEN"	
			VC_REALLOCATION_TYPE="NONATOMIC"
			AVC_ATOMIC_EN=1	
			echo "DUATO_ODD_EVEN"
		;;
...
run_sim(){
	...
	for  routename in "DUATO_NORTH_LAST" "DUATO_BASELINE" "DUATO_ODD_EVEN" "DUATO_XY"     "XY" "WEST_FIRST" "ODD_EVEN"  "NEGETIVE_FIRST" 
	do	
		route_setting
		gen_testbench_name
		regenerate_NoC
	...
	#for  routename in "DUATO_BASELINE"  "DUATO_MINE" "DUATO_WPF"
	for  routename in "DUATO_ODD_EVEN" "DUATO_XY"  "DUATO_NORTH_LAST" "DUATO_BASELINE" 
	do	
		route_setting
		gen_testbench_name
		CMD="./$testbench_name $testbench_name"
	...
	#for  routename in "XY" "WEST_FIRST" "ODD_EVEN"  "NEGETIVE_FIRST" "DUATO_BASELINE"  "DUATO_MINE"  "DUATO_WPF"
	for  routename in "DUATO_ODD_EVEN" "DUATO_XY"  "DUATO_NORTH_LAST" "DUATO_BASELINE"  "XY" "WEST_FIRST" "ODD_EVEN"  "NEGETIVE_FIRST" 
	do	

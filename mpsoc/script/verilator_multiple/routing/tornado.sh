...
multiple_path=$work_path/mesh_2d_tornado3
...
#simulation parameters:
 ...
 # Simulation parameters:   
	...
	CONGESTION_INDEX=7	# 0: packets are routed to the ports with more available VCs
...
for B in    4
do					
 for PACKET_SIZE in 2   
 do 
	for	TRAFFIC in  "BIT_COMPLEMENT"  #"TRANSPOSE2" "TRANSPOSE1" "BIT_REVERSE" "RANDOM" "HOTSPOT"  "TORNADO" 
	do
		for   CONGESTION_INDEX in   7 #0 1 2 3
		do

	...
	localparam RNF_ENDP_ID = gen_rn_endp_id(i);
	 ...
	 //connect request node to endp 1
        ...
        (
            ...
            .chi_noc_txreqflitpend(chi_noc_txreqflitpend_all[RNF_ENDP_ID]),
            .chi_noc_txreqflitv(chi_noc_txreqflitv_all[RNF_ENDP_ID]),
            .chi_noc_txreqflit(chi_noc_txreqflit[RNF_ENDP_ID]),
            .noc_chi_txreqlcrdv(noc_chi_txreqlcrdv_all[RNF_ENDP_ID]),
            .chi_noc_txdatflitpend(chi_noc_txdatflitpend_all[RNF_ENDP_ID]),
            .chi_noc_txdatflitv(chi_noc_txdatflitv_all[RNF_ENDP_ID]),
            .chi_noc_txdatflit(chi_noc_txdatflit[RNF_ENDP_ID]),
            .noc_chi_txdatlcrdv(noc_chi_txdatlcrdv_all[RNF_ENDP_ID]),
            .chi_noc_txrspflitpend(chi_noc_txrspflitpend_all[RNF_ENDP_ID]),
            .chi_noc_txrspflitv(chi_noc_txrspflitv_all[RNF_ENDP_ID]),
            .chi_noc_txrspflit(chi_noc_txrspflit[RNF_ENDP_ID]),
            .noc_chi_txrsplcrdv(noc_chi_txrsplcrdv_all[RNF_ENDP_ID]),
            .noc_chi_rxrspflitpend(noc_chi_rxrspflitpend_all[RNF_ENDP_ID]),
            .noc_chi_rxrspflitv(noc_chi_rxrspflitv_all[RNF_ENDP_ID]),
            .noc_chi_rxrspflit(noc_chi_rxrspflit[RNF_ENDP_ID]),
            .chi_noc_rxrsplcrdv(chi_noc_rxrsplcrdv_all[RNF_ENDP_ID]),
            .noc_chi_rxdatflitpend(noc_chi_rxdatflitpend_all[RNF_ENDP_ID]),
            .noc_chi_rxdatflitv(noc_chi_rxdatflitv_all[RNF_ENDP_ID]),
            .noc_chi_rxdatflit(noc_chi_rxdatflit[RNF_ENDP_ID]),
            .chi_noc_rxdatlcrdv(chi_noc_rxdatlcrdv_all[RNF_ENDP_ID]),
            .noc_chi_rxsnpflitpend(noc_chi_rxsnpflitpend_all[RNF_ENDP_ID]),
            .noc_chi_rxsnpflitv(noc_chi_rxsnpflitv_all[RNF_ENDP_ID]),
            .noc_chi_rxsnpflit(noc_chi_rxsnpflit[RNF_ENDP_ID]),
            .chi_noc_rxsnplcrdv(chi_noc_rxsnplcrdv_all[RNF_ENDP_ID]),
            .chi_noc_txsnpflitpend(chi_noc_txsnpflitpend_all[RNF_ENDP_ID]),
            .chi_noc_txsnpflitv(chi_noc_txsnpflitv_all[RNF_ENDP_ID]),
            .chi_noc_txsnpflit(chi_noc_txsnpflit[RNF_ENDP_ID]),
            .noc_chi_txsnplcrdv(noc_chi_txsnplcrdv_all[RNF_ENDP_ID]),
            .noc_chi_rxreqflitpend(noc_chi_rxreqflitpend_all[RNF_ENDP_ID]),
            .noc_chi_rxreqflitv(noc_chi_rxreqflitv_all[RNF_ENDP_ID]),
            .noc_chi_rxreqflit(noc_chi_rxreqflit[RNF_ENDP_ID]),
            .chi_noc_rxreqlcrdv(chi_noc_rxreqlcrdv_all[RNF_ENDP_ID]),
            .snp_target_id(snp_target_id[RNF_ENDP_ID])
        );

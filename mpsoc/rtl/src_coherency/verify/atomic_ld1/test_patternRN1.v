...
`ifdef     INCLUDE_TEST_PATTERN
   ...
   $display("***************1st transition  WriteBackfull rn1************");   
    ...
    repeat (REPEAT_NUM)begin 
        ...
        read_addr[1]= read_addr[1]+ 2* CACHE_BLK_SIZ;
	Write_dat[1]= Write_dat[1]+ 2* CACHE_BLK_SIZ+ 'hFFFFFFFFFFFFFFFFFFFFFFF0000;
...
$display("***************2nd transition: Readshared rn0************");
    ...
    repeat(REPEAT_NUM)begin
        ...
        read_addr[0]= read_addr[0]+ 2* CACHE_BLK_SIZ;	

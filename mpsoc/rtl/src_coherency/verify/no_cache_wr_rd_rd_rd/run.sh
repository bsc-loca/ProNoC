...
say "Error Expected 6000 Cache wr in cache RN0 in UC state but got $uc1" if( $uc1!=6000) ;
say "Error Expected 0 Cache wr in syscache in UC state but got $uc2" if( $uc2!=0) ;
say "Error Expected 30000 Cache wr in  in SC state but got $sc" if( $sc!=30000) ;

...
LD_MISS="0"    #load miss percentage
ST_MISS="100"	#store miss percentage
...
function gen_trace_files {
	...
	$trace_gen_path/tracegen -p "$trace_path/delay$max_delay" -r $rn_nums -t "RANDOM" -a $min_addr -b $max_addr -l 1 -u $u -L $LD_MISS -S $ST_MISS -n $trace_num_per_rnf
}

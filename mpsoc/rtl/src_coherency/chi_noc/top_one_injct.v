...
(
  ...
  localparam CACHE_ADDRw = ADDR_REQ,
   ...
   localparam        
    ...
    input [NUM_OF_RNs-1 : 0] cache_to_core_wr_ready_all;
    ...
    always @(posedge clk or posedge reset) begin
     ...
     // TIM Interface
        ...
        // CHI NoC Interface                                            
        // TXREQ
        .chi_noc_txreqflitpend_o(chi_noc_txreqflitpend_all[0]),
        .chi_noc_txreqflitv_o(chi_noc_txreqflitv_all[0]),
        .chi_noc_txreqflit_o(chi_noc_txreqflit[0]),
        .noc_chi_txreqlcrdv_i(noc_chi_txreqlcrdv_all[0]),
        
        // TXDAT  
        .chi_noc_txdatflitpend_o(chi_noc_txdatflitpend_all[0]),
        .chi_noc_txdatflitv_o(chi_noc_txdatflitv_all[0]),
        .chi_noc_txdatflit_o(chi_noc_txdatflit[0]),
        .noc_chi_txdatlcrdv_i(noc_chi_txdatlcrdv_all[0]),
        
        // TXRSP 
        .chi_noc_txrspflitpend_o(chi_noc_txrspflitpend_all[0]),
        .chi_noc_txrspflitv_o(chi_noc_txrspflitv_all[0]),
        .chi_noc_txrspflit_o(chi_noc_txrspflit[0]),
        .noc_chi_txrsplcrdv_i(noc_chi_txrsplcrdv_all[0]),
        
        // CRSP/RXRSP
        .noc_chi_rxrspflitpend_i(noc_chi_rxrspflitpend_all[0]),
        .noc_chi_rxrspflitv_i(noc_chi_rxrspflitv_all[0]),
        .noc_chi_rxrspflit_i(noc_chi_rxrspflit[0]),
        .chi_noc_rxrsplcrdv_o(chi_noc_rxrsplcrdv_all[0]),
        
         // RDAT 
        .noc_chi_rxdatflitpend_i(noc_chi_rxdatflitpend_all[0]),
        .noc_chi_rxdatflitv_i(noc_chi_rxdatflitv_all[0]),
        .noc_chi_rxdatflit_i(noc_chi_rxdatflit[0]),
        .chi_noc_rxdatlcrdv_o(chi_noc_rxdatlcrdv_all[0]),
        
        // SNP/RXSNP  
        .noc_chi_rxsnpflitpend_i(noc_chi_rxsnpflitpend_all[0]),
        .noc_chi_rxsnpflitv_i(noc_chi_rxsnpflitv_all[0]),
        .noc_chi_rxsnpflit_i(noc_chi_rxsnpflit[0]),
        .chi_noc_rxsnplcrdv_o(chi_noc_rxsnplcrdv_all[0])                                         
    ...
    for(i=1;i<NUM_OF_RNs;i=i+1)begin: rn

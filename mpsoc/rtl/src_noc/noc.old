...
module  noc #(
    ...
    //    e.g: in fattree:
    //    T1: K, number of last level individual router`s endpoints. T2: L layer number, T3,T4 are not used    
    ...
    parameter [V-1 :  0] ESCAP_VC_MASK = 4'b1000,  // mask escape vc, valid only for full adaptive

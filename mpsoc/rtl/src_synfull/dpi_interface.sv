...
import "DPI-C" function void c_dpi_interface ( 
    ...
    output  logic  endCom                            , 
    output  logic  newReq                            , 
    output  int    source_all[16]                    , 
    output  int    destination_all[16]               , 
    output  int    address_all[16]                   ,
    output  int    opcode_all[16]                    ,
    output  int    id_all[16]                        ,
    output  int    valid_all[16]                     ,
...
int syn_source_all[16]          ;
int syn_opcode_all[16]          ;
int syn_destination_all[16]     ;
int syn_address_all[16]         ;
int syn_pkgid_all[16]           ;
int syn_valid_all[16]           ;

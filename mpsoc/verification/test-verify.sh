...
SIM_TES_IN2=(
# simulation_file  		gen_model  	run_sim 	save_path  			reference_result 
"test.SIM"  			"yes"  		"yes"  	        "result_test"  			"ref1"
"test1.SIM"  			"yes"  		"yes"           "result_test1"  		"ref2"
)
...
for ((index=0; index<${#SIM_TES_IN2[@]}; index+=5)) 
do
    sim_file=${SIM_TES_IN2[index]}
    gen_model=${SIM_TES_IN2[index+1]}
    run_sim=${SIM_TES_IN2[index+2]}
    result_path=${SIM_TES_IN2[index+3]}
    ref_file=${SIM_TES_IN2[index+4]}

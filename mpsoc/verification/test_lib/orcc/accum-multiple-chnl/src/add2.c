// Source file is "L/chanel/src/accum/add2.cal"
...
static void read_Input2() {
	index_Input2 = add2_Input2->read_inds[1];
	numTokens_Input2 = index_Input2 + fifo_i32_get_num_tokens(add2_Input2, 1);
}

static void read_end_Input2() {
	add2_Input2->read_inds[1] = index_Input2;
}

...
DECLARE_FIFO(i32, 32, 2, 2)
DECLARE_FIFO(i32, 32, 3, 1)
DECLARE_FIFO(i32, 32, 4, 1)

/////////////////////////////////////////////////
// FIFO pointer assignments
fifo_i32_t *src1_Output1 = &fifo_0;
fifo_i32_t *add1_Input1 = &fifo_0;

fifo_i32_t *src1_Output2 = &fifo_1;
fifo_i32_t *add2_Input1 = &fifo_1;

fifo_i32_t *src2_source = &fifo_2;
fifo_i32_t *add1_Input2 = &fifo_2;
fifo_i32_t *add2_Input2 = &fifo_2;

fifo_i32_t *add1_Output = &fifo_3;
fifo_i32_t *print1_result = &fifo_3;

fifo_i32_t *add2_Output = &fifo_4;
fifo_i32_t *print2_result = &fifo_4;
...
network_t network = {"accum.top", actors, connections, 6, 6};

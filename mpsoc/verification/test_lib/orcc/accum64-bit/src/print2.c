// Source file is "L/add/src/accumulatorv2/printer2.cal"
...
////////////////////////////////////////////////////////////////////////////////
// Input FIFOs
extern fifo_i64_t *print2_result;
...
#define rate_result connection_print2_result.rate
...
static void read_result() {
	index_result = print2_result->read_inds[0];
	numTokens_result = index_result + fifo_i64_get_num_tokens(print2_result, 0);
}

static void read_end_result() {
	print2_result->read_inds[0] = index_result;
}
...
static void untagged_0() {
	...
	local_temp = temp;
	if (local_temp == 20) {
		printf("The result printer2 is %lli\n", a);
	}
...
void print2_initialize(schedinfo_t *si) {
	int i = 0;
finished:
	return;
}
...
////////////////////////////////////////////////////////////////////////////////
// Action scheduler
void print2_scheduler(schedinfo_t *si) {
	int i = 0;
	si->ports = 0;

...
////////////////////////////////////////////////////////////////////////////////
// Input FIFOs
extern fifo_i16_t *add2_Input1;
extern fifo_i16_t *add2_Input2;
...
static void read_Input1() {
	...
	numTokens_Input1 = index_Input1 + fifo_i16_get_num_tokens(add2_Input1, 0);
}
...
static void read_Input2() {
	...
	numTokens_Input2 = index_Input2 + fifo_i16_get_num_tokens(add2_Input2, 0);
}

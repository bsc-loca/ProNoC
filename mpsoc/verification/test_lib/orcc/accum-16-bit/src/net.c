...
/////////////////////////////////////////////////
// FIFO allocation
DECLARE_FIFO(i16, 512, 0, 1)
DECLARE_FIFO(i16, 512, 1, 1)
DECLARE_FIFO(i16, 512, 2, 1)
DECLARE_FIFO(i16, 512, 3, 1)
DECLARE_FIFO(i16, 512, 4, 1)
DECLARE_FIFO(i16, 512, 5, 1)

/////////////////////////////////////////////////
// FIFO pointer assignments
fifo_i16_t *src1_Output1 = &fifo_0;
fifo_i16_t *add1_Input1 = &fifo_0;

fifo_i16_t *src1_Output2 = &fifo_1;
fifo_i16_t *add2_Input1 = &fifo_1;

fifo_i16_t *src2_Output1 = &fifo_2;
fifo_i16_t *add1_Input2 = &fifo_2;

fifo_i16_t *src2_Output2 = &fifo_3;
fifo_i16_t *add2_Input2 = &fifo_3;

fifo_i16_t *add1_Output = &fifo_4;
fifo_i16_t *print1_result = &fifo_4;

fifo_i16_t *add2_Output = &fifo_5;
fifo_i16_t *print2_result = &fifo_5;

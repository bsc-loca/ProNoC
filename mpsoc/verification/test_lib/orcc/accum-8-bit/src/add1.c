...
////////////////////////////////////////////////////////////////////////////////
// Input FIFOs
extern fifo_i8_t *add1_Input1;
extern fifo_i8_t *add1_Input2;
...
static void read_Input1() {
	...
	numTokens_Input1 = index_Input1 + fifo_i8_get_num_tokens(add1_Input1, 0);
}
...
static void read_Input2() {
	...
	numTokens_Input2 = index_Input2 + fifo_i8_get_num_tokens(add1_Input2, 0);
}
